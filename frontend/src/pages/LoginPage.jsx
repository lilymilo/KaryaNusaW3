      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-[2rem] p-8 border border-gray-200 dark:border-gray-700 shadow-xl relative overflow-hidden group transition-colors">
          ...
          <button
            ...
            className="w-full relative z-10 flex items-center justify-center gap-3 sm:gap-4 bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 border border-gray-200 dark:border-gray-700 py-3.5 sm:py-4 px-4 sm:px-6 rounded-2xl text-gray-900 dark:text-white font-black transition-all active:scale-[0.98] group text-sm sm:text-base"
          >
            <svg className="w-5 h-5 sm:w-6 sm:h-6 shrink-0 group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
            ...
            <span className="truncate">Lanjut dengan Google</span>
          </button>
          ...
          <div className="relative z-10">
            <button
              ...
              className="w-full relative overflow-hidden flex items-center justify-center gap-3 sm:gap-4 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700/50 border border-gray-200 dark:border-gray-700 py-3.5 sm:py-4 px-4 sm:px-6 rounded-2xl text-gray-900 dark:text-white font-black transition-all shadow-sm active:scale-[0.98] group disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base"
            >
              ...
              {walletLoading === WALLET_TYPES.UNIVERSAL ? (
                <div className="w-5 h-5 sm:w-6 sm:h-6 border-2 border-orange-500 border-t-transparent rounded-full animate-spin shrink-0 relative z-10"></div>
              ) : (
                <div className="opacity-70 group-hover:opacity-100 transition-opacity shrink-0 relative z-10 flex items-center justify-center group-hover:scale-110">
                  <UniversalWalletIcon />
                </div>
              )}
              <span className="relative z-10 truncate">{walletLoading === WALLET_TYPES.UNIVERSAL ? 'Menghubungkan...' : 'Lanjut dengan Connect Wallet'}</span>
            </button>
          </div>
