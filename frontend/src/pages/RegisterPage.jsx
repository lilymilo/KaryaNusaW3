      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-[2rem] p-5 sm:p-8 border border-gray-200 dark:border-gray-700 shadow-xl relative z-10 transition-colors">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 sm:gap-4 bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 border border-gray-200 dark:border-gray-700 py-3.5 sm:py-4 px-4 sm:px-6 rounded-2xl text-gray-900 dark:text-white font-black transition-all shadow-sm active:scale-[0.98] text-sm sm:text-base group"
          >
          ...
          <div className="relative z-10">
            ...
            >
              ...
              {walletLoading === WALLET_TYPES.UNIVERSAL ? (
                <Loader2 size={20} className="animate-spin text-orange-500 relative z-10 shrink-0" />
              ) : (
                <div className="group-hover:scale-110 transition-transform relative z-10 w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center shrink-0">
                  <UniversalWalletIcon />
                </div>
              )}
              <span className="relative z-10 truncate">{walletLoading === WALLET_TYPES.UNIVERSAL ? 'Menghubungkan...' : 'Daftar via Universal Wallet'}</span>
            </button>
          </div>
